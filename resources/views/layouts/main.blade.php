...
<head>
    ...
    <style>
        ...
        *::after {
        ...
        /* Variants */
        .toast-success { border-left: 4px solid #34c472; }
        .toast-success .toast-icon { background: #e8f8ee; color: #34c472; }
        .toast-success::after { background: #34c472; }

        .toast-error { border-left: 4px solid #e05a5a; }
        .toast-error .toast-icon { background: #fdeaea; color: #e05a5a; }
        .toast-error::after { background: #e05a5a; }

        .toast-warning { border-left: 4px solid #f5a54a; }
        .toast-warning .toast-icon { background: #fff3e6; color: #f5a54a; }
        .toast-warning::after { background: #f5a54a; }

        .toast-info { border-left: 4px solid #4A90D9; }
        .toast-info .toast-icon { background: #e8f0fd; color: #4A90D9; }
        .toast-info::after { background: #4A90D9; }
        ...
        .toast-close:hover { color: #5a7090; background: #f0f4fb; }
        ...
        .confirm-btn-batal:hover { background: #e2e8f4; }
        ...
        .confirm-btn-hapus:hover { background: #c94848; transform: translateY(-1px); }
    </style>
