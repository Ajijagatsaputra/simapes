...
@section('title', 'Status Pesanan - SIMAPES')
...
@section('content')
    <div class="status-container">
        {{-- Header --}}
        <div>
            <h1 style="font-size: 1.6rem; font-weight: 800; color: #1a2b4a;">Status Pesanan Aktif</h1>
            <p style="font-size: .85rem; color: #6b7e9f; margin-top: 4px;">Pantau status pengerjaan pesanan seragam Anda
        ...
        <div class="card">
            <div class="table-toolbar">
                <span class="table-title">Pesanan Berjalan</span>
