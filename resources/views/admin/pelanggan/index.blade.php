...
@section('content')
    ...
    <div class="pelanggan-layout">
        ...
        <div class="card form-panel" id="formPanel">
            ...
            <form method="POST" id="formPelanggan" action="{{ route('admin.pelanggan.store') }}">
                @csrf
...
@push('scripts')
    <script>
        ...
        function openForm() {
            ...
            document.getElementById('formPelanggan').action = '{{ route("admin.pelanggan.store") }}';
        ...
        function editPelanggan(id, nama, wa, alamat, sekolah) {
            ...
            document.getElementById('formPelanggan').action = '/admin/pelanggan/' + id;
