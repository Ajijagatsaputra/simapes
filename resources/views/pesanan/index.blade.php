                    ...
                    <tr>
                        ...
                        <td>
                            <div class="aksi-wrap">
                                ...
                                <form method="POST" action="{{ route('pesanan.destroy', $p->id) }}" id="form-hapus-pesanan-{{ $p->id }}" style="display:inline">
                                    @csrf @method('DELETE')
                                    <button type="button" class="btn-hapus" title="Hapus" onclick="confirmHapus(document.getElementById('form-hapus-pesanan-{{ $p->id }}'), '{{ $p->no_pesanan }}')">
                                        <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
